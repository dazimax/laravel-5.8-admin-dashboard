...
$(document).ready(function(){
    ...
    $("#sortable1, #sortable4, #sortable3, #sortable5, #sortable6, #sortable7").sortable({
	...
	$('form#createChart').submit(function(e){
		...
		if($('ul#sortable4').find('li').length == 0){
        	new PNotify({
			    title: 'Error!',
			    text: 'You have to select atleast one column for the demo X section',
			    type: 'error'
			});
			return false;
		}
		...
		if($('ul#sortable5').find('li').length == 0){
			new PNotify({
				title: 'Error!',
				text: 'You have to select atleast one column for the demo Y section',
				type: 'error'
			});
			return false;
		}
		...
		if($('ul#sortable6').find('li').length == 0){
			new PNotify({
				title: 'Error!',
				text: 'You have to select atleast one column for the Scatter X section',
				type: 'error'
			});
			return false;
		}
		if($('ul#sortable7').find('li').length == 0){
			new PNotify({
				title: 'Error!',
				text: 'You have to select atleast one column for the Scatter Y section',
				type: 'error'
			});
			return false;
		}
