...
<!-- Mirrored from hubancreative.com/projects/templates/coco/corporate/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Jun 2016 20:05:14 GMT -->
<head>
        <meta charset="UTF-8">
    ...
    <div class="container">
        <div class="full-content-center animated flipInX">
            ...
            <br>
            <a class="btn btn-primary btn-sm" href="/user/profile"><i class="fa fa-angle-left"></i> Back to Dashboard</a>
        </div>
    </div>
    <!-- End of page -->
