...
<div class="page-heading">
    <h1><i class='fa fa-check'></i> All Email Templates</h1>
</div>
<!-- Page Heading End-->
...
<!--                                <a href="{{ url('/user/profile/cms/pages/remove') }}" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>-->
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        @if (!empty($emailtemplates))
                            @foreach ($emailtemplates as $emailtemplate)
                                <tr>
                                    ...
                                    <td><strong>{{ $emailtemplate->identifier }}</strong></td>
                                    <td><strong>{{ $emailtemplate->title }}</strong></td>
                                    <td>
                                        <?php
                                         if($emailtemplate->visible == 1){
                                        ?>
                                    ...
                                    <td>
                                        <a href="{{ url('/email/templates/view/'.$emailtemplate->id) }}" data-toggle="tooltip" title="Edit" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                        <a href="{{ url('/email/templates/remove/'.$emailtemplate->id) }}" data-toggle="tooltip" title="Remove" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
