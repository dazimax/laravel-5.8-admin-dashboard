...
<div class="widget-content padding">
    ...
    <form class="form-horizontal" method="POST" action="{{ url('/user/profile/cms/pages/new/save') }}" role="form">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="toolbar-btn-action">
                    ...
                    <a href="{{ url('/user/profile/cms/pages/remove/'.$cmspage->pageId) }}" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                    <a href="{{ url('/user/profile/cms/pages') }}" class="btn btn-warning"><i class="fa fa-back"></i> Back</a>
    ...
    <br/>
        ...
        <div class="form-group">
            <label for="input-text" class="col-sm-2 control-label">Page Title</label>
            <div class="col-sm-10">
                <input type="text" name="title" value="{{ $cmspage->title }}" class="form-control" id="input-text"/>
            </div>
        </div>

        <div class="form-group">
            <label for="input-text" class="col-sm-2 control-label">Url Identifier</label>
            <div class="col-sm-10">
                <input type="text" name="identifier" value="{{ $cmspage->identifier }}" class="form-control" id="input-text"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea name="content" class="summernote">{{ $cmspage->content }}</textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <label class="checkbox-inline checked"  style="display: inline;padding:0">
                    <input  style="float:left;margin-left: 0;" name="visible" type="checkbox" id="visiblecheckbox" value="{{ $cmspage->visible }}" <?php echo ($cmspage->visible==1)?'checked':'' ?> />
                </label>
            </div>
        </div>
        ...
        <input type="hidden" name="pageId" value="{{ $cmspage->pageId }}"/>
    </form>

@else

    <div class="page-heading">
        <h1><i class='fa fa-check'></i> Add New Page</h1>
    </div>
    <!-- Page Heading End-->
    ...
    <div class="widget">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">Page Content</label>
            <div class="col-sm-10">
                <textarea name="content" class="summernote">Add page content here</textarea>
            </div>
        </div>
