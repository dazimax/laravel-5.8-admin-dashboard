...
<div class="page-heading">
    <h1><i class='fa fa-check'></i> All CMS Pages</h1>
</div>
<!-- Page Heading End-->
                        ...
                        @if (isset($cmspages))
                            @foreach ($cmspages as $cmspage)
                                <tr>
                                    ...
                                    <td><strong>{{ $cmspage->title }}</strong></td>
                                    <td>
                                        <?php
                                         if($cmspage->visible == 1){
                                        ?>
                                    ...
                                    <td>
                                        <a href="{{ url('/user/profile/cms/pages/view/'.$cmspage->pageId) }}" data-toggle="tooltip" title="Edit" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                        <a href="{{ url('/user/profile/cms/pages/remove/'.$cmspage->pageId) }}" data-toggle="tooltip" title="Remove" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
