...
<div class="page-heading">
    <h1><i class='fa fa-check'></i> All Roles</h1>
</div>
<!-- Page Heading End-->
                        ...
                        @if (isset($roles))
                            @foreach ($roles as $role)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/user/access/roles/view/'.$role->id) }}" data-toggle="tooltip" title="Edit" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                        <a href="{{ url('/user/access/roles/remove/'.$role->id) }}" data-toggle="tooltip" title="Remove" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
